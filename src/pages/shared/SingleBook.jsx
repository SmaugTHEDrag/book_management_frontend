...
const SingleBook = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      if (token) {
        try {
          const likeRes = await fetch(`https://book-management-backend-eghi.onrender.com/api/favorites/${id}/has`, {
  ...
  const handleFavorite = async () => {
    ...
    try {
      ...
      const url = hasFavorited 
        ? `https://book-management-backend-eghi.onrender.com/api/favorites/${id}`
        : 'https://book-management-backend-eghi.onrender.com/api/favorites';
  ...
  const handleSubmitReview = async (e) => {
    ...
    try {
      ...
      const url = userReview 
        ? `https://book-management-backend-eghi.onrender.com/api/reviews/${userReview.id}`
        : 'https://book-management-backend-eghi.onrender.com/api/reviews';
  ...
  const handleDeleteReview = async () => {
    ...
    const token = localStorage.getItem('token');
    try {
      const res = await fetch(`https://book-management-backend-eghi.onrender.com/api/reviews/${userReview.id}`, {
        method: 'DELETE',
        headers: { Authorization: `Bearer ${token}` },
      });
