...
const BlogDetail = () => {
  ...
  const fetchBlogDetail = async () => {
    try {
      setLoading(true);
      const res = await axios.get(`https://book-management-backend-eghi.onrender.com/api/blogs/${id}`, {
        headers: authHeaders,
      });
      ...
      if (isLoggedIn) {
        try {
          const likeRes = await axios.get(
            `https://book-management-backend-eghi.onrender.com/api/blogs/${id}/likes/has`,
            { headers: authHeaders }
          );
  ...
  const toggleLike = async () => {
    ...
    try {
      if (blog.hasLiked) {
        await axios.delete(`https://book-management-backend-eghi.onrender.com/api/blogs/${id}/likes`, {
          headers: authHeaders,
        });
      } else {
        await axios.post(
          `https://book-management-backend-eghi.onrender.com/api/blogs/${id}/likes`,
          {},
          { headers: authHeaders }
        );
      }
  ...
  const addComment = async (content, parentId = null) => {
    ...
    try {
      ...
      await axios.post(
        `https://book-management-backend-eghi.onrender.com/api/blogs/${id}/comments`,
        {
          blogId: id,
          content,
  ...
  const saveEdit = async () => {
    ...
    try {
      await axios.put(
        `https://book-management-backend-eghi.onrender.com/api/blogs/${id}`,
        {
  ...
  const removeBlog = async () => {
    try {
      await axios.delete(`https://book-management-backend-eghi.onrender.com/api/blogs/${id}`, {
        headers: authHeaders,
      });
      navigate('/blog');
    } catch (err) {
