  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (useImageFile || usePdfFile) {
        ...
        response = await fetch(`https://book-management-backend-eghi.onrender.com/api/books/${id}/upload`, {
          method: "PUT",
          headers: headers,
          body: formDataObj,
        });
      ...
      // Using URLs (original method)
        ...
        response = await fetch(`https://book-management-backend-eghi.onrender.com/api/books/${id}`, {
          method: "PUT",
          headers: headers,
