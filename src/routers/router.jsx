...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        path: "/book/:id",
        element: <SingleBook />,
        loader: ({ params }) => fetch(`https://book-management-backend-eghi.onrender.com/api/books/${params.id}`)
      },
      {
        path: "/book/:id/read",
        element: <BookReader />,
      ...
      },
      {
        path: "/blog/:id",
        element: <BlogDetail />,
        loader: ({ params }) => fetch(`https://book-management-backend-eghi.onrender.com/api/blogs/${params.id}`)
      }
    ]
  },
  {
